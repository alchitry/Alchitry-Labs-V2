...
enum class Artix7IoStandard(
    ...
    override val diffTerm: Boolean = false,
    ...
    LVDS_25("2.5", inputAnyVcco = true, slew = null, diffTerm = true),
    LVTTL("3.3", drive = listOf(4, 8, 12, 16, 24)),
    MINI_LVDS_25("2.5", inputAnyVcco = true, slew = null, diffTerm = true),
    PCI33_3("3.3", slew = null),
    PPDS_25("2.5", inputAnyVcco = true, slew = null, directions = PinDirection.single, diffTerm = true),
    RSDS_25("2.5", inputAnyVcco = true, slew = null, directions = PinDirection.single, diffTerm = true),
...
enum class Ice40IoStandard(
    ...
    override val diffTerm: Boolean
) : IoStandard {
    LVCMOS33("3.3", false, null, null, PinDirection.all, false),
}