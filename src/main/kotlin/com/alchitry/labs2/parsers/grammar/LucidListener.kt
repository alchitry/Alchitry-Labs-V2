...
public interface LucidListener : ParseTreeListener {
    ...
    /**
     * Enter a parse tree produced by [LucidParser.caseJunk].
     *
     * @param ctx The parse tree
     */
    public fun enterCaseJunk(ctx: LucidParser.CaseJunkContext)

    /**
     * Exit a parse tree produced by [LucidParser.caseJunk].
     *
     * @param ctx The parse tree
     */
    public fun exitCaseJunk(ctx: LucidParser.CaseJunkContext)
    ...
    override fun asSuspend(): SuspendLucidListener = object : SuspendLucidListener {
        ...
        override suspend fun enterCaseJunk(ctx: LucidParser.CaseJunkContext) = this@LucidListener.enterCaseJunk(ctx)
        override suspend fun exitCaseJunk(ctx: LucidParser.CaseJunkContext) = this@LucidListener.exitCaseJunk(ctx)
...
public interface SuspendLucidListener : SuspendParseTreeListener {
     ...
     * @param ctx The parse tree
     */
    public suspend fun enterCaseJunk(ctx: LucidParser.CaseJunkContext)
     ...
     * @param ctx The parse tree
     */
    public suspend fun exitCaseJunk(ctx: LucidParser.CaseJunkContext)
