...
class AcfParser(input: TokenStream) : Parser(input) {
	...
	companion object {
        ...
        val ruleNames = arrayOf(
            ...
            "nativeBlock", "name", "attribute", "attributeValue",
            "portName", "pinName", "frequency", "arrayIndex",
            "number", "semi"
        )
    ...
    private val NATIVE_BLOCK = Tokens.NATIVE_BLOCK.id
	...
	open class LineContext : ParserRuleContext {
        ...
        fun nativeBlock(): NativeBlockContext? = getRuleContext(NativeBlockContext::class, 0)
    ...
    open class NativeBlockContext : ParserRuleContext {
        override var ruleIndex: Int
            get() = Rules.RULE_nativeBlock.id
            set(value) {
                throw RuntimeException()
            }

        fun NATIVE_BLOCK(): TerminalNode? = getToken(Tokens.NATIVE_BLOCK.id, 0)
        ...
        override fun deepCopy(): NativeBlockContext {
            return NativeBlockContext().also {
                deepCopyInto(it)
            }
        }

        override fun enterRule(listener: ParseTreeListener) {
            if (listener is AcfListener) listener.enterNativeBlock(this)
        }

        override suspend fun enterRule(listener: SuspendParseTreeListener) {
            if (listener is SuspendAcfListener) listener.enterNativeBlock(this)
        }

        override fun exitRule(listener: ParseTreeListener) {
            if (listener is AcfListener) listener.exitNativeBlock(this)
        }

        override suspend fun exitRule(listener: SuspendParseTreeListener) {
            if (listener is SuspendAcfListener) listener.exitNativeBlock(this)
        }
    }

    fun nativeBlock(): NativeBlockContext {
        var _localctx: NativeBlockContext = NativeBlockContext(context, state)
        enterRule(_localctx, 8, Rules.RULE_nativeBlock.id)
        try {
            enterOuterAlt(_localctx, 1)
            scoped {
                this.state = 71
    ...
    fun name(): NameContext {
        ...
        enterRule(_localctx, 10, Rules.RULE_name.id)
		var _la: Int
		try {
			enterOuterAlt(_localctx, 1)
			scoped {
    ...
    fun attribute(): AttributeContext {
        ...
        enterRule(_localctx, 12, Rules.RULE_attribute.id)
		try {
			enterOuterAlt(_localctx, 1)
			scoped {
                this.state = 76
    ...
    fun attributeValue(): AttributeValueContext {
        ...
        enterRule(_localctx, 14, Rules.RULE_attributeValue.id)
		try {
            this.state = 84
			errorHandler.sync(this)
    ...
    fun portName(): PortNameContext {
        ...
        enterRule(_localctx, 16, Rules.RULE_portName.id)
		var _la: Int
		try {
			enterOuterAlt(_localctx, 1)
			scoped {
    ...
    fun pinName(): PinNameContext {
        ...
        enterRule(_localctx, 18, Rules.RULE_pinName.id)
		try {
			enterOuterAlt(_localctx, 1)
			scoped {
                this.state = 106
    ...
    fun frequency(): FrequencyContext {
        ...
        enterRule(_localctx, 20, Rules.RULE_frequency.id)
		try {
			enterOuterAlt(_localctx, 1)
			scoped {
                this.state = 108
    ...
    fun arrayIndex(): ArrayIndexContext {
        ...
        enterRule(_localctx, 22, Rules.RULE_arrayIndex.id)
		try {
			enterOuterAlt(_localctx, 1)
			scoped {
                this.state = 111
    ...
    fun number(): NumberContext {
        ...
        enterRule(_localctx, 24, Rules.RULE_number.id)
		var _la: Int
		try {
			enterOuterAlt(_localctx, 1)
			scoped {
    ...
    fun semi(): SemiContext {
        ...
        enterRule(_localctx, 26, Rules.RULE_semi.id)
		var _la: Int
		try {
            this.state = 126
			errorHandler.sync(this)
