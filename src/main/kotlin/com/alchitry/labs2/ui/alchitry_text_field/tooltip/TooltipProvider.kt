package com.alchitry.labs2.ui.alchitry_text_field.tooltip
...
abstract class TooltipProvider<T>(val codeEditor: AlchitryTextFieldState) {
...
class NotationTooltipProvider(
    codeEditor: AlchitryTextFieldState,
