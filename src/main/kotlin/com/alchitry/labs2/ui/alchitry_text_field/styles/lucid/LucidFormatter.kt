...
class LucidFormatter : CodeFormatter {
    override fun getIndentFor(textProvider: TextProvider, line: Int): String {
        //val listener = ConsoleErrorListener.INSTANCE
        val lexer = LucidLexer(CharStreams.fromString(textProvider.getText())).apply { removeErrorListeners() }
    ...
    override fun formatAll(textProvider: TextProvider): String {
        val cleanedText = removeSemicolons(textProvider.getText())
