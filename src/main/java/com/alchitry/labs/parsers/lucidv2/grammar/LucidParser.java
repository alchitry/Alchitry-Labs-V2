...
public class LucidParser extends Parser {
    ...
    public static final int
            RULE_source = 0, RULE_global = 1, RULE_globalStat = 2, RULE_interfaceDec = 3,
            RULE_module = 4, RULE_paramList = 5, RULE_portList = 6, RULE_paramDec = 7,
            ...
            RULE_alwaysBlock = 32, RULE_alwaysStat = 33, RULE_block = 34, RULE_assignStat = 35,
            RULE_arrayIndex = 36, RULE_bitSelector = 37, RULE_bitSelection = 38, RULE_signal = 39,
            RULE_caseStat = 40, RULE_caseElem = 41, RULE_caseBlock = 42, RULE_ifStat = 43,
            RULE_elseStat = 44, RULE_repeatStat = 45, RULE_repeatBlock = 46, RULE_function = 47,
            RULE_number = 48, RULE_expr = 49, RULE_name = 50, RULE_semi = 51;

    private static String[] makeRuleNames() {
        return new String[]{
                "source", "global", "globalStat", "interfaceDec", "module", "paramList",
                ...
                "conList", "connection", "structMember", "structDec", "alwaysBlock",
                "alwaysStat", "block", "assignStat", "arrayIndex", "bitSelector", "bitSelection",
                "signal", "caseStat", "caseElem", "caseBlock", "ifStat", "elseStat",
                "repeatStat", "repeatBlock", "function", "number", "expr", "name", "semi"
        };
    }
	...
	public final SourceContext source() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
            {
                ...
                _la = _input.LA(1);
                while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 2305843009213694018L) != 0)) {
                    {
                        setState(107);
                        _errHandler.sync(this);
                        switch (_input.LA(1)) {
	...
	public final GlobalContext global() throws RecognitionException {
		...
		try {
			...
			enterOuterAlt(_localctx, 1);
            {
                ...
                _errHandler.sync(this);
                _la = _input.LA(1);
                while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 51380240L) != 0)) {
                    {
                        {
                            setState(135);
                            globalStat();
    ...
    public static class InterfaceDecContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_interfaceDec;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof LucidListener) ((LucidListener) listener).enterInterfaceDec(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof LucidListener) ((LucidListener) listener).exitInterfaceDec(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof LucidVisitor) return ((LucidVisitor<? extends T>) visitor).visitInterfaceDec(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public final InterfaceDecContext interfaceDec() throws RecognitionException {
        ...
        enterRule(_localctx, 6, RULE_interfaceDec);
        int _la;
        try {
            int _alt;
            enterOuterAlt(_localctx, 1);
	...
	public final ModuleBodyContext moduleBody() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
            {
                ...
                _errHandler.sync(this);
                _la = _input.LA(1);
                while (((((_la - 18)) & ~0x3f) == 0 && ((1L << (_la - 18)) & 272678883688957L) != 0)) {
                    {
                        setState(491);
                        _errHandler.sync(this);
                        switch (_input.LA(1)) {
	...
	public final AssignBlockContext assignBlock() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
            {
                ...
                _errHandler.sync(this);
                _la = _input.LA(1);
                while (((((_la - 18)) & ~0x3f) == 0 && ((1L << (_la - 18)) & 272678883688489L) != 0)) {
                    {
                        setState(544);
                        _errHandler.sync(this);
                        switch (_input.LA(1)) {
		...
		try {
			...
			switch (_input.LA(1)) {
                    ...
                    enterOuterAlt(_localctx, 1);
                {
                    ...
                    _errHandler.sync(this);
                    _la = _input.LA(1);
                    while (((((_la - 29)) & ~0x3f) == 0 && ((1L << (_la - 29)) & 124554051605L) != 0)) {
                        {
                            setState(884);
                            _errHandler.sync(this);
                            switch (_input.LA(1)) {
	...
	public final CaseStatContext caseStat() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
            {
                ...
                _errHandler.sync(this);
                _la = _input.LA(1);
                while ((((_la) & ~0x3f) == 0 && ((1L << _la) & -5782498551560797692L) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & 7L) != 0)) {
                    {
                        setState(1075);
                        _errHandler.sync(this);
                        switch (_input.LA(1)) {
	...
	public final IfStatContext ifStat() throws RecognitionException {
        ...
        enterRule(_localctx, 86, RULE_ifStat);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
            {
	...
	public final ElseStatContext elseStat() throws RecognitionException {
        ...
        enterRule(_localctx, 88, RULE_elseStat);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
            {
	...
	public final RepeatStatContext repeatStat() throws RecognitionException {
        ...
        enterRule(_localctx, 90, RULE_repeatStat);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
            {
	...
	public final RepeatBlockContext repeatBlock() throws RecognitionException {
        ...
        enterRule(_localctx, 92, RULE_repeatBlock);
        try {
            enterOuterAlt(_localctx, 1);
            {
                setState(1195);
                        ...
                        _prevctx = _localctx;
                        {
                            ...
                            switch (getInterpreter().adaptivePredict(_input, 206, _ctx)) {
                                ...
                                case 5: {
                                    ...
                                    setState(1425);
                                    _la = _input.LA(1);
                                    if (!((((_la) & ~0x3f) == 0 && ((1L << _la) & 2111062325985280L) != 0))) {
                                        _errHandler.recoverInline(this);
                                    } else {
                                        if (_input.LA(1) == Token.EOF) matchedEOF = true;
                                        _errHandler.reportMatch(this);
